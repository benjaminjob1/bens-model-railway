...
export default function InteractiveTrain() {
  ...
  // Update SVG bounding rect when it changes
  ...
  useEffect(() => {
    ...
    const updatePosition = (p: number) => {
      ...
      // Convert SVG coordinates (0-800, 0-400) to actual pixel position
      // within the rendered SVG element
    ...
    // ResizeObserver to track SVG size changes
  ...
  }, [isDragging, visible, track, trackMode, svgRect, updateSvgRect]);
      ...
      <div className="track-container">
        <div className="track-inner">
          ...
          >
            ...
            {/* Main oval track - ballast (lighter grey) */}
            ...
            {/* Hidden paths for interaction - wide hit area */}
          ...
          {/* Trail dots - inside the track-inner container (position: absolute) */}
          {trail.map(dot => (
            <div
              key={dot.id}
          ...
          {/* Train cursor - inside track-inner, positioned with pixel coords */}
          <div
            ref={trainRef}
